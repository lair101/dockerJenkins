...
<mappingRoot domainID="com.ibm.msl.mapping.xml" domainIDExtension="mb" mainMap="false" targetNamespace="default" version="8.0.3.0" xmlns="http://www.ibm.com/2008/ccl/Mapping" xmlns:map="default">
	...
	<mappingDeclaration name="CreateHL7Segment_DSC">
		<input path="BLOB"/>
		<output namespace="urn:hl7-org:v2xml" path="DSC"/>
MAP;
echo			"<assign value=\"$assignValue\">\n";
echo				"<output path=\"DSC.1.ContinuationPointer\"/>\n";
echo			"</assign>\n";
echo			"<assign value=\"$assignValue\">\n";
echo				"<output path=\"DSC.2.ContinuationStyle\"/>\n";
echo			"</assign>\n";
echo			"<assign value=\"$assignValue\">\n";
