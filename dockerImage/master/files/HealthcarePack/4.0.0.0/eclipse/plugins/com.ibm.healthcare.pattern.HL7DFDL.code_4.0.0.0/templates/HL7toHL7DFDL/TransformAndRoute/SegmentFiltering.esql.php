BROKER SCHEMA TransformAndRoute
...
ESQL;
    ...
    CREATE PROCEDURE SetSequenceField() BEGIN
        ...
        IF InputRoot.XMLNSC.hl7:HL7.hl7:MSH.hl7:"MSH.13.SequenceNumber" IS NULL THEN
           -- Version ID is mandatory, therefore we can create the sequence number as next sibling
           CREATE NEXTSIBLING OF OutputRoot.DFDL.hl7:HL7.hl7:MSH.hl7:"MSH.12.VersionID" NAMESPACE hl7 NAME 'MSH.13.SequenceNumber' VALUE ' ';
        END IF;  
    END; 
END MODULE;
ESQL;
    ...
    BEGIN
        ...
        CALL CopyMessageHeaders();
        DECLARE ref REFERENCE TO InputRoot.XMLNSC.hl7:HL7.*:*;
...
ESQL;
            ...
            echo "        DECLARE I INTEGER 1;\n";          
            echo "        WHILE LASTMOVE(ref) DO\n";
            echo "            DECLARE CurrentFieldName CHAR FIELDNAME(ref);\n";
            echo "            IF CurrentFieldName = 'anyHL7Segment' THEN\n";
            echo "            	SET CurrentFieldName = FIELDNAME(ref.*:*[1]);\n";
            echo "            END IF;\n";
            if ($segmentIndex > 0) {
	            ...
	            echo "            	IF CurrentFieldName = 'MSH' THEN \n";
		        echo "	                CREATE LASTCHILD OF OutputRoot.DFDL.hl7:HL7 NAMESPACE hl7 NAME CurrentFieldName; \n";
		        echo "	                SET OutputRoot.DFDL.hl7:HL7.*:*[<] = ref; \n";
	            echo "            	ELSE \n";
	            echo "	                CREATE LASTCHILD OF OutputRoot.DFDL.hl7:HL7.hl7:anyHL7Segment[I] NAMESPACE hl7 NAME CurrentFieldName; \n";
		        echo "	                SET OutputRoot.DFDL.hl7:HL7.*:*[<] = ref; \n";
		        echo "	                SET I = I+1; \n";
	            echo "            	END IF; \n";            	
            	echo "            END IF; \n";
