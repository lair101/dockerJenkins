...
DECLARE SenderMessageSet CONSTANT CHARACTER '';
DECLARE SenderMessageType CONSTANT CHARACTER '{urn:hl7-org:v2xml}:HL7';
DECLARE SenderMessageFormat CONSTANT CHARACTER '';
...
CREATE COMPUTE MODULE SequenceToEnvironment
    CREATE FUNCTION Main() RETURNS BOOLEAN
    BEGIN
        SET Environment.PatternVariables.DestinationSequenceNumber = InputRoot.DFDL.hl7:HL7.hl7:MSH.hl7:"MSH.13.SequenceNumber";
