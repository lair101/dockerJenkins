    ...
    BEGIN
        ...
        IF (LocalEnv.FlowMilestoneReached IS NOT NULL) THEN
            IF (LocalEnv.SendNACK = 'YES') THEN
                ...
                CALL healthcare.BuildACKMSH(LocalEnv.InputMSH, OutputRoot.MRM.hl7:MSH);             
                -- Build MSA segment for acknowledgement message
                CALL healthcare.BuildACKMSA(LocalEnv.InputMSH, OutputRoot.MRM.hl7:MSA, LocalEnv.HL7RC, LocalEnv.ErrorCondition);                
            END IF;
        ELSE
...
ESQL;
        ...
        echo <<<ESQL
            ...
            SET OutputRoot.MRM = NULL; -- Delete the MRM tree
