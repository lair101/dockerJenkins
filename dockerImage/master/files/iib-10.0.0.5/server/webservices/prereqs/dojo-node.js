(function(
	...
	var configNode_function = function(config){
		// summary:
	...
	has.add = function(name, test, now, force){
	 ...
	 1 || has.add("host-node", userConfig.has && "host-node" in userConfig.has ?
		userConfig.has["host-node"] :
		(typeof process == "object" && process.versions && process.versions.node && process.versions.v8));
	if( 1 ){
		// fixup the default config for node.js environment
		//require("./_base/configNode.js").config(defaultConfig);
		configNode_function(defaultConfig);
	...
	var def = function(
		...
		}else if(!has("ie-event-behavior") || ! 0  || injectingCachedModule){
...
define(["./has!dom-addeventlistener?:./aspect", "./_base/kernel", "./has"], function(aspect, dojo, has){
	...
	"use strict";
	if( 0 ){ // check to make sure we are in a browser, this module should work anywhere
...
'dojo/ready':function(){
define(["./_base/kernel", "./has", "require", "require", "./_base/lang"], function(dojo, has, require, domReady, lang){
	// module:
	//		dojo/ready
	// note:
