...
<xsl:stylesheet version="1.0" xmlns:xsl="http://www.w3.org/1999/XSL/Transform" xmlns:xsd="http://www.w3.org/2001/XMLSchema" xmlns:fo="http://www.w3.org/1999/XSL/Format" xmlns:ri="http://www.ibm.com/xmlns/prod/websphere/wbi/ReportingInfrastructure/" xmlns:java="http://xml.apache.org/xalan/java" extension-element-prefixes="java" exclude-result-prefixes="fo ri">
	...
	<!--*********************************************************************-->
	<!-- template to report all namespaces of the all datatypes          -->
			...
			<fo:table-body>
				...
				<xsl:for-each select="namespace::*">
					<xsl:call-template name="MakeNamespaceRow">
						...
						<xsl:with-param name="namespace" select="java:com.ibm.etools.msg.reporting.reportunit.mxsd.NamespaceUtils.convertUriToNamespace(.)"/>
					</xsl:call-template>
				</xsl:for-each>
			</fo:table-body>
		</fo:table>
